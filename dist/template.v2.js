(function (factory) {
  ...
  class FrontMatter {
    constructor() {
      ...
      this.journal = {};
      //  journal: {
      //    'full_title': 'Sophie Distill',
      //    'abbrev_title': 'Sophie Distill',
      //    'url': 'http://sophie-distill.space',
      //    'doi': 'N/A',
      //    'publisherName': 'Sophie Crawford Haynes',
      //    'publisherEmail': 'N/A',
      //    'issn': 'N/A',
      //    'editors': [...],
      //    'committee': [...]
...
`;
  ...
  function appendixTemplate(frontMatter) {
    ...
    <pre class="citation short">${frontMatter.concatenatedAuthors}, "${frontMatter.title}", Sophie Distill, ${frontMatter.publishedYear}.</pre>
    <p>BibTeX citation</p>
...
<div class='footer-container'>
  ...
  <a href="/" class="logo">
    ${logo}
    Sophie Distill
  </a> is dedicated to continuing high quality research into AI safety with clear explanations.

  <div class="nav">
    <a href="https://distill.pub/">Distill</a>
    <a href="https://sophie-distill.space/about/">About</a>
